                ...
                <div class="card">
                    ...
                    <div class="col-md-12">
                        <div class="ibox">
                            ...
                            <form action="{{ URL::route($url.'.update', $rows[0]->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="ibox-content">
                                    <p class="col-12 mb-0 pt-2"><strong>ID: </strong>{{$rows[0]->journal_short_form}}-0000{{ $rows[0]->id }}&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Title: </strong>{{$rows[0]->title}}&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="card-header pb-0 px-2 bg-light border-bottom-0">
                                        <ul class="nav nav-tabs col-20" id="nav-tab">
                                            ...
                                            @if($previous_id !== null)
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ url('dashboard/admin/submission/show/'.$previous_id) }}"><i class="fas fa-chevron-left"></i> Previous</a>
                                            </li>
                                            @endif
                                            ...
                                            @if($next_id !== null)
                                            <li class="nav-item ">
                                                        <a class="nav-link" href="{{ url('dashboard/admin/submission/show/'.$next_id) }}"><i class="fas fa-chevron-right"></i> Next</a>
                                                    </li>
                                            @endif
                                            ...
                                            <li class="nav-item">
                                                <a data-toggle="tab" class="nav-link" href="#history"><i class="fa fa-history"></i> History</a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <div class="tab-content">
                                            <div id="details" class="tab-pane ib-tab-box active">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 10px;">
                                                                <p class="mb-0">
                                                                    ...
                                                                    {{-- <span class="badge badge-pill" style="color:red;border:1px solid red">hiasdjhajshdkjh</span> --}}
                                                                    @if(isset($selected[0]->statusname))
                                                                    <span class="badge badge-pill" style="background-color:{{$selected[0]->colourflag}}; color:#ffffff;border:1px solid {{$selected[0]->colourflag}}">{{$selected[0]->statusname}}</span>
                                                                    @else
                                                                    <span class="label label-primary" id='priority_status' style="color:red;border:1px solid red">-</span>
                                                                    @endif
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 10px;">
                                                                <p class="mb-0">
                                                                    ...
                                                                    <span class="label label-primary" id='priority_status' style="color:#2196f3;">{{$selected[0]->processingname}}</span>
                                                                    @else
                                                                    <span class="label label-primary" id='priority_status' style="color:#2196f3;">-</span>
                                                                    @endif
                                                                    {{-- <span class="label label-primary" id='priority_status' style="color:#2196f3;">-</span> --}}
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                                ...
                                                                <input value="{{$selected[0]->journalname}}" class="form-control" id="journal_type" disabled>
                                                                    {{-- @if(isset($selected[0]->journalname))
                                                                    <option value="{{$selected[0]->journal_type}}" selected>{{$selected[0]->journalname}}</option>
                                                                    @else
                                                            ...
                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 10px;">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select class="form-control" name="article_type" id="article_type">
                                                                        ...
                                                                        <option value="{{$selected[0]->article_type}}" selected>{{$selected[0]->articlename}}</option>
                                                                        @else
                                                            ...
                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 10px;">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select class="form-control" name="issue_type" id="issue_type">
                                                                        ...
                                                                        <option value="{{$selected[0]->issue_type}}" selected>{{$selected[0]->issuename}}</option>
                                                                        @else
                                                                        <option value="">Select article Type</option>
                                                                        @endif
                                                            ...
                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 10px;">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select class="form-control" name="processing_type" id="processing_type">
                                                                        @if(isset($selected[0]->processingname))
                                                                        <option value="{{$selected[0]->processing_type}}" selected>{{$selected[0]->processingname}}</option>
                                                                        @else
                                                                        <option value="">Select article Type</option>
                                                                        @endif
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 10px;">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select class="form-control" name="status_type" id="status_type">
                                                                        @if(isset($selected[0]->statusname))
                                                                        <option value="{{$selected[0]->status_type}}" selected>{{$selected[0]->statusname}}</option>
                                                                        @else
                                                                        <option value="">Select article Type</option>
                                                                        @endif
                                                                        @foreach( $statuss as $status )
                                                                        @if ($status->id == 2 || $status->id == 4 || $status->id == 5 || $status->id == 6 || $status->id == 7 || $status->id == 8 || $status->id == 15 || $status->id == 17)
                                                                        <option value="{{ $status->id }}">{{ $status->name }}&nbsp;&nbsp;&nbsp;[M]<?php if($status->id == 2 || $status->id == 5 || $status->id == 6 || $status->id == 15){echo ' [S]';} ?></option>
                                                                        @else
                                                            ...
                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 10px;">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select class="form-control" name="status" id="activation_status">
                                                            ...
                                                            <div class="col-md-4 col-xs-12" style="">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="{{$selected[0]->scheduled_on}}" type="date" class="form-control" name="scheduled_on" id="scheduled_on" placeholder="Scheduled Date">
                                                                    @else
                                                                    <input type="date" class="form-control" name="scheduled_on" id="scheduled_on" placeholder="Scheduled Date">
                                                                    @endif
                                                                    <div class="invalid-feedback">
                                                                      Please Select Article Research Area.
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4 col-xs-12" style="">
                                                                <div class="form-group">
                                                                    <p class="mb-2"><strong>Author: </strong>{{$author[0]->authorname}}</p>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-4 col-xs-12" style="">
                                                                <div class="form-group">
                                                                    <p class="mb-2"><strong>Email: </strong>{{$author[0]->email}}</p>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-4 col-xs-12" style="">
                                                                <div class="form-group">
                                                                    <p class="mb-2"><strong>Phone: </strong>{{$author[0]->phone}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 col-xs-12">
                                                                ...
                                                                <textarea class="form-control summernote" name="notes" id="notes" rows="8" required>{{$selected[0]->notes}}</textarea>
                                                                @else
                                                                <textarea class="form-control summernote" name="notes" id="notes" rows="8" required></textarea>
                                                                @endif
                                                    ...
                                                    <div class="col-md-12 text-left mt-3">
                                                        <button type="submit" class="btn btn-blue upload_file waves-effect waves-light">Save</button>
                                                    </div>
                                                </form>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row col-12">
                                                    <div class="col-xl-4 col-lg-4 col-12">
                                                        <form action="{{ URL::route($url.'.task', $rows[0]->id) }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <button type="submit" class="btn btn-blue upload_file waves-effect waves-light">Save</button><br><br>
                                                        </form>
                                                    </div>
                                                      ...
                                                      <div class="kanban-column-cards">
                                                        @foreach($tasks as $task)
                                                          ...
                                                          <div class="kanban-card" draggable="true" data-card-id="{{ $task->id }}">
                                                            ...
                                                            <div class="kanban-card-description">ID : {{$rows[0]->journal_short_form}}-0000{{ $rows[0]->id }}</div>
                                                                @if (isset($task->image_path))
                                                                <div class="kanban-card-description">Staff : <img src="{{ asset('/uploads/profile/'.$task->image_path) }}" class="staff-profile-image-small" alt="Default Profile Picture">{{ $task->staffname }}</div>
                                                                @else
                                                                <div class="kanban-card-description">Staff : <img src="https://png.pngtree.com/png-clipart/20210129/ourmid/pngtree-default-male-avatar-png-image_2811083.jpg" class="staff-profile-image-small" alt="Default Profile Picture">{{ $task->staffname }}</div>
                                                                @endif
                                            ...
                                            <div id="files" class="tab-pane fade ib-tab-box">
                                                ...
                                                <div id="modal_upload_file" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="needs-validation" novalidate action="{{url('dashboard/admin/submission/author_file/'.$rows[0]->id)}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">{{-- download article --}}
                                                                            ...
                                                                            <a href="{{ asset('uploads/article/'.$selected[0]->file_path) }}" download><button type="button" class="btn btn-sm btn-success"><i class="fa fa-download"></i>
                                                                            </button></a>
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <div id="plagiarism_report" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="needs-validation" novalidate action="{{url('dashboard/admin/submission/plagiarism_report/'.$rows[0]->id)}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                ...
                                                <div id="certificate_details" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="needs-validation" novalidate action="{{url('dashboard/admin/submission/certificate_details/'.$rows[0]->id)}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                ...
                                                <div id="published_article_details" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="needs-validation" novalidate action="{{url('dashboard/admin/submission/published_article_details/'.$rows[0]->id)}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                            ...
                                            <div id="review" class="tab-pane fade ib-tab-box">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <form action="{{ URL::route($url.'.review', $rows[0]->id) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <table class="table table-bordered table-hover sys_table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="text-center"><a href="{{url('dashboard/admin/submission/review-question/'.$review->id)}}">#{{$review->id}}</a></td>
                                                                    ...
                                                                    @if (!empty($review_status))
                                                                        ...
                                                                        @foreach ($review_status as $singleData)
                                                                            @if ($singleData->article_id == $review->article_id && $singleData->review_id == $review->id)
                                                                                @php
                                                                                    $isComplete = true;
                                                                                @endphp
                                                                                <td><span class="badge badge-pill" style="background-color:#008000; color:#ffffff;border:1px solid #99ff33">Submitted</span> 
                                                                                <a href="{{url('dashboard/admin/article/show_review_evalution/'.$review->id)}}"><i class="fa fa-eye"></i></a></td>
                                                                                <td class="text-center">
                                                                                <select class="custom-select review_decision" id="review_decision_{{ $review->id }}">
                                                                                    <option value="{{ $review->decision }}" selected>{{ $review->decision }}</option>
                                                                        ...
                                                                        @endforeach
                                                                        @if (!$isComplete)
                                                                            <td><span class="badge badge-pill" style="background-color:#ff3300; color:#ffffff;border:1px solid #ff704d">Not Submitted</span></td>
                                                                            <td class="text-center">
                                                                                <select class="custom-select review_decision" id="review_decision_{{ $review->id }}">
                                                                                    <option value="{{ $review->decision }}" selected>{{ $review->decision }}</option>
                                                                                    <option value="Not Complete">Not Complete</option>
                                                      ...
                                                      <div class="kanban-column-cards">
                                                        @foreach($reviews as $review)
                                                          ...
                                                          <div class="kanban-card" draggable="true" data-id="{{ $review->id }}">
                                                            ...
                                                            <div class="kanban-card-description">Reviewer: <img src="https://png.pngtree.com/png-clipart/20210129/ourmid/pngtree-default-male-avatar-png-image_2811083.jpg" class="staff-profile-image-small" alt="Default Profile Picture">{{ $review->reviername }}</div>
                                            ...
                                            <div id="acceptance" class="tab-pane fade ib-tab-box">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-default">
                                                            <div class="panel-body">
                                                                <a data-toggle="modal" href="#acceptance_details" class="btn btn-blue upload_file waves-effect waves-light" id="upload_file"><i class="fa fa-plus"></i> New Acceptance</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="acceptance_details" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="needs-validation" novalidate action="{{url('dashboard/admin/submission/acceptance/'.$rows[0]->id)}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <input class="form-control" type="text" name="scheduled_to" required>
                                                                    </div>

                                                                    <div class="col-md-12"><br>
                                                                        <label>Published On</label>
                                                                        <input class="form-control" type="month" name="published_on" required>
                                                                    </div>
                                                            ...
                                                            <table class="table table-bordered table-hover sys_table">
                                                                ...
                                                                <tbody>
                                                                   @foreach ($acceptances as $acceptance )
                                                                    <tr>
                                                                        <td>{{$rows[0]->journal_short_form}}-0000{{ $acceptance->article_id }}</td>
                                                                        ...
                                                                        <td>
                                                                            <select class="custom-select" id="acceptance_status">
                                                                                <option value="{{$acceptance->status}}" selected>{{$acceptance->status}}</option>
                                                                        ...
                                                                        <td>
                                                                            <select class="custom-select" id="acceptance_action">
                                                                                @if($acceptance->action_for_author)
                                                                                    <option value="{{$acceptance->action_for_author }}" selected>{{$acceptance->action_for_author }}</option>
                                                    ...
                                                    {{-- <div class="col-md-12">
                                                        <div class="panel panel-default">
                                                            <div class="panel-body">
                                                                ...
                                                                <a href="{{url('dashboard/admin/submission/copyright_form/'.$rows[0]->id)}}" class="btn btn-blue upload_file waves-effect waves-light" id="accept_save"><i class="fa fa-download"></i> Download</a>
                                                            </div>
                                                        </div>
                                                    </div> --}}
                                                    <h4>Generate the Copyright Form</h4>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-default">
                                                            <div class="panel-body">
                                                                ...
                                                                <a data-toggle="modal" href="#final_manuscript" class="btn btn-blue upload_file waves-effect waves-light mb-2" id="upload_file"><i class="fa fa-plus"></i> New File Upload</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="final_manuscript" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title"><i class="fa fa-upload"></i> File Manuscript Upload</h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center" style="width:125px;">
                                                                            ...
                                                                            <a href="{{ asset('uploads/final_submission/'.$final_manuscript->file_path) }}" download><button type="button" class="btn btn-sm btn-success"><i class="fa fa-download"></i>
                                                                            </button></a>
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-default">
                                                            <div class="panel-body">
                                                                ...
                                                                <a data-toggle="modal" href="#final_copy_rights" class="btn btn-blue upload_file waves-effect waves-light mb-2" id="upload_file"><i class="fa fa-plus"></i> New File Upload</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center" style="width:125px;">
                                                                            ...
                                                                            <a href="{{ asset('uploads/final_submission/'.$final_copy_right_form->file_path) }}" download><button type="button" class="btn btn-sm btn-success"><i class="fa fa-download"></i>
                                                                            </button></a>
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-default">
                                                            <div class="panel-body">
                                                                ...
                                                                <a data-toggle="modal" href="#payment_script" class="btn btn-blue upload_file waves-effect waves-light mb-2" id="upload_file"><i class="fa fa-plus"></i> New File Upload</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center" style="width:125px;">
                                                                            ...
                                                                            <a href="{{ asset('uploads/final_submission/'.$final_payment_script->file_path) }}" download><button type="button" class="btn btn-sm btn-success"><i class="fa fa-download"></i>
                                                                            </button></a>
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" align="center">
                                                        <div class="panel panel-default">
                                                            <div class="panel-body">
                                                                {{-- <h3>After </h3><br> --}}
                                                                <a href="{{ URL::route('final_submission.unfreeze', $rows[0]->id) }}" class="btn btn-blue upload_file waves-effect waves-light"> Reset</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
