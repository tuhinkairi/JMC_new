                      ...
                      <form class="needs-validation" novalidate action="{{ URL::route('reviewer.'.$url.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="{{ $row->name }}" placeholder="Profile Name" required disabled>
                        ...
                        <div class="row">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="phone" id="phone" value="{{ $row->phone }}" placeholder="Phone" disabled>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="address" id="address" value="{{ $row->address }}" placeholder="Address" required disabled>
