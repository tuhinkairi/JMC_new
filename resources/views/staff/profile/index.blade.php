...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <a href="{{ URL::route('staff.'.$url.'.index') }}" class="btn btn-info">Refresh</a>
        </div>
    </div>
                ...
                <div class="card-body">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane show active" id="profile-tab">
                      ...
                      @foreach( $rows as $row )
                      <!-- Form Start -->
                      <form class="needs-validation" novalidate action="{{ URL::route('staff.'.$url.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
