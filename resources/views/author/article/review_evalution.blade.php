...
<div class="container-fluid">
    ...
    @foreach ($rows as $row)
        ...
        @if ($row->comment_1 !== 'Hide from Author' )
        ...
        @if ($row->comment_2 !== 'Hide from Author' )
        ...
        @if ($row->comment_3 !== 'Hide from Author' )
        ...
        @if ($row->comment_4 !== 'Hide from Author' )
        ...
        @if ($row->comment_5 !== 'Hide from Author' )
        ...
        @if ($row->comment_6 !== 'Hide from Author' )
        ...
        @if ($row->comment_7 !== 'Hide from Author' )
        ...
        @if ($row->comment_8 !== 'Hide from Author' )
        ...
        @if ($row->comment_9 !== 'Hide from Author' )
        ...
        @if ($row->comment_10 !== 'Hide from Author' )
        ...
        @if ($row->comment_11 !== 'Hide from Author' )
        ...
        @if ($row->comment_12 !== 'Hide from Author' )
        ...
        @if ($row->comment_13 !== 'Hide from Author' )
