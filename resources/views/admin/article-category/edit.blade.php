              ...
              <form class="needs-validation" novalidate action="{{ URL::route($url.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="title">Research Area Title</label>
                        <input type="text" class="form-control" name="title" id="title" value="{{ $row->title }}" placeholder="Research Area Title" required>

                        <div class="invalid-feedback">
                          Please Provide Research Area Title.
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="details">Research Area Details</label>
