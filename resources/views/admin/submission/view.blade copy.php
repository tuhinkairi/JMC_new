                                                ...
                                                <div id="modal_upload_file" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="needs-validation" novalidate action="{{url('dashboard/admin/submission/file/'.$rows[0]->id)}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                        ...
                                                        <table class="table table-bordered table-hover sys_table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <select class="custom-select" id="review_decision">
